...
public class UserServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        String data ="";
        //String path = /*req.getRealPath(*/".."+File.separator+".."+File.separator+".."+File.separator+"files" + File.separator + "images" + File.separator + "UserImg"/*)*/;
        String path=req.getRealPath("files"+File.separator+"images"+File.separator+"UserImg");
        //String path = "../../../files\\images\\UserImg";
        ...
        if (formType.equalsIgnoreCase("full")) {
            ...
            String from="morganokumu8@gmail.com";
...
"                        \n" +
                         "<h5 class=\"mt-3 col-12 text-primary merienda text-right\">House</h5>\n" +
"                        <div class=\"col-6 mt-1\">Name : </div>\n" +
"                        <div class=\"col-6  text-right text-muted\">- "+house.getName()+"</div>\n" +
"                        <div class=\"col-6 mt-1\">Address :</div>\n" +
"                        <div class=\"col-6  text-right text-muted\">+91 "+house.getAddress()+"</div>\n" +
"                        <div class=\"col-6 mt-1\">Area:</div>\n" +
"                        <div class=\"col-6  text-right text-muted\" >"+house.getDistrict()+"</div>\n" +
"                        \n" +
"                    </div>\n" +
"                    \n"+
               ...
               if(ownerUser.get(0).getId() == loginUser.getId()) {
                    if(tenant.getStates().equalsIgnoreCase("Apply") ){
                       ...
                       data+="<span class=\"p-2 bg-dark text-light notAllowToTenant \"data-id='"+tenant.getId()+"' data-states='dismiss'  >Not Allow</span>\n" ;
                        ...
                        data+="<span class=\"p-2 bg-dark text-light notAllowToTenant \"data-id='"+tenant.getId()+"' data-states='privious' >Cancel Agreement</span>\n" ;
                    }
